...
namespace MyCMS.Migrations
{
    ...
    [Migration("20221103050418_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCMS.ContentManagementSystem.ContentManagementSystem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppContentManagementSystem");
                });
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MyCMS.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MyCMS.Authorization.Users.User", null)
                        .WithMany("Claims")
