...
{
    public abstract class MyCMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyCMSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyCMSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyCMSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyCMSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyCMSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyCMSDbContext, Task<T>> func)
        {
            T result;
